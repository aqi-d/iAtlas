...
function initRuntimeSocketService() {
  const hosts = "192.168.188.90,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_92pRzE";
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      text: "报告列表",
      iconPath: "static/document.png",
      selectedIconPath: "static/document.png"
    }
  ]
};
const uniIdRouter = {};
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.188.90"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/15431/Desktop/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"aqi","spaceId":"mp-fa2d4671-a5b6-4b91-ad1f-2424e84a69b4","clientSecret":"Y+oJvNHkqqEyt8wA4uoRkQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__B35FF51";
} catch (e2) {
